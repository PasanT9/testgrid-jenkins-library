...
ssh -v -o StrictHostKeyChecking=no -o UserKnownHostsFile=/dev/null -i ${keyFileLocation} $instanceUser@${WSO2InstanceName} "mkdir -p /opt/testgrid/workspace/dbscripts/apimgt/"
...
scp -v -o StrictHostKeyChecking=no -o UserKnownHostsFile=/dev/null -i ${keyFileLocation} oracle.sql $instanceUser@${WSO2InstanceName}:/opt/testgrid/workspace/dbscripts
